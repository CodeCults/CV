...
const BlogPostCard = ({ slug, title, date, excerpt }: BlogPostCardProps) => {
  return (
    <Link href={`/blog/${slug}`} passHref>
      <div className="block group bg-gray-100 dark:bg-gray-800/50 p-6 rounded-lg transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-500/20 cursor-pointer">
